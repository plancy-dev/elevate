...
7. **[#8](https://github.com/plancy-dev/elevate/issues/8) P3** — 제품: 포맷 힌트·Preflight 예산 문구·`scene-budget-constants` (구현됨); Figma 프레임·수락 체크는 디자인.
...
| P3 포맷·예산 가드(제품) | [#8](https://github.com/plancy-dev/elevate/issues/8) (open) | `FORMAT_SPECS` 힌트·Preflight에 서버 동일 90s/180s 문구·`scene-budget-constants` |
...
| [#8](https://github.com/plancy-dev/elevate/issues/8) | P3 포맷·예산 가드 | 코드 UX 반영됨; Figma·최종 사인오프 |
