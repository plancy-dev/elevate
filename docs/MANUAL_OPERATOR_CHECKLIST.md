...
| **Vercel / GitHub** | 프로덕션·프리뷰 환경 변수, E2E용 Secrets (`NEXT_PUBLIC_SUPABASE_*`); **`/dashboard`**는 `profiles.dashboard_access` 또는 `role = admin` + 서버 `SUPABASE_SERVICE_ROLE_KEY` 필요 — [`DEVELOPMENT.md`](./DEVELOPMENT.md) § Dashboard access |
