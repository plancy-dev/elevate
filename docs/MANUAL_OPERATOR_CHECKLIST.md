...
| **Vercel / GitHub** | 프로덕션·프리뷰 환경 변수, E2E용 Secrets (`NEXT_PUBLIC_SUPABASE_*`); **대시보드 게이트** 켤 경우 `DASHBOARD_ACCESS_STRICT`·`SUPABASE_SERVICE_ROLE_KEY`·[`DEVELOPMENT.md`](./DEVELOPMENT.md) § Dashboard access |
