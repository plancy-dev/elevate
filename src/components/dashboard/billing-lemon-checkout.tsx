    ...
    return (
      <div className="space-y-4">
        <div
          ...
          role="alert"
        >
          <p className="font-medium text-text-primary">{t("lemonMissingUrlTitle")}</p>
          <p className="mt-2 leading-relaxed">{t("lemonMissingUrlBody")}</p>
        </div>
        {organizationId && customDataJson ? (
