...
- **Phase 2 (partial BUILD):** TOC 항목 `aria-current="page"` + PostHog `elevate_dashboard_sidebar_nav_click` — 계약 테스트 [`tests/unit/dashboard-sidebar-nav-analytics.test.ts`](../../tests/unit/dashboard-sidebar-nav-analytics.test.ts).
